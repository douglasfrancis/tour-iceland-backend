...
const emailClientFromInbox = (email, chatId) => {
  ...
  const msg = {
    ...
    subject: 'Tour Iceland | New Message!',
    text: "Hello, you have a new message. Please enable HTML.",
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         <tr>
                          <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:5px;padding-top:20px"><h1 style="Margin:0;line-height:55px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#333333">New Message</h1></td>
                         </tr>
                         <tr>
                          <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img class="adapt-img" src="https://firebasestorage.googleapis.com/v0/b/tour-iceland.appspot.com/o/chat.png?alt=media&token=8bb6c452-d7c4-4697-8709-4e28e90fd389" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="300" height="300"></td>
                         </tr>
                       </table></td>
                     </tr>
                   </table></td>
                       ...
                       <table cellpadding="0" cellspacing="0" class="es-right" align="right" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                         <tr>
                          <td align="left" style="padding:0;Margin:0;width:501px">
                           <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             <tr>
                              <td align="left" class="es-m-txt-l" style="padding:0;Margin:0;padding-bottom:5px"><h3 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#333333">You have a new message! Click on the link below to view and respond to your guides.</h3></td>
                             </tr>
                           </table></td>
                         </tr>
                       </table></td>
                         ...
                         <tr>
                          <td align="left" style="padding:0;Margin:0;width:501px">
                           <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             ...
                             <tr>
                              <td align="center" class="es-m-txt-l" style="padding:30px;Margin:0px;padding-bottom:20px"><a href="https://tour-iceland.netlify.app/public/inbox/${chatId}"><button style="background-color: #8FBCBB;padding:15px;color:#fff;border: unset;font-weight:bold">View Message</button></a></td>
                             </tr>
                           </table></td>
                         </tr>
                       </table></td>
